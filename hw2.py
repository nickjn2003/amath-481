...
def shoot2(phi, dummy, n0, epsilon):
    return [phi[1], (n0**2 - epsilon) * phi[0]]

tol = 1e-4  # define a tolerance level 
col = ['r', 'b', 'g', 'c', 'm', 'k']  # eigenfunc colors
n0 = 10; A = 1; x0 = [0, A]; xp = [-4, 4] 
...
for modes in range(1, 6):  # begin mode loop
    ...
    depsilon = n0 / 100  # default step size in beta
    for _ in range(1000):  # begin convergence loop for beta
        y = odeint(shoot2, x0, xshoot, args=(n0, epsilon)) 
